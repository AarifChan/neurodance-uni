  ...
  <view class="content_view">
    <view class="alarm_clock_view">
      ...
      <view class="clock_data_view">
        <view class="clock_data_context_view" id="yearAverageBreathe"></view>
      </view>
...
export default {
  ...
  methods: {
    setECharts() {
      var myChart = echarts.init(document.getElementById('yearAverageBreathe'))
      ...
      var option = {
        ...
        series: [
          {
            data: [0, 0, 0, 0, 0, 30, 42, 37, 35, 40, 35, 38],
            type: 'line',
            symbol: 'circle',
            symbolSize: 8,
            itemStyle: {
