    ...
    <view class="deep_long_view">
      <view class="deep_long_top_view">
        <view class="eeg_alarm_left_view">
          <text class="clock_title_view">本年夜间深睡时长</text>
      ...
      <view class="deep_long_data_view">
        <view class="clock_data_context_view" id="deepYearLong"></view>
      </view>
...
export default {
  ...
  methods: {
    setECharts() {
      var myChart = echarts.init(document.getElementById('deepYearLong'))
