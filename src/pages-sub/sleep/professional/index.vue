...
<template>
  <view class="content_view">
    <!-- 顶部操作栏 -->
    <view class="top_view">
      <image src="/static/images/sleep/btn_ico_zuojiantou_nor.png" @click="yesterday"></image>
      <view class="date_text_view" @click="selectTime()">
        <text>{{ dataStr }}</text>
        <image class="select_date_view" src="/static/images/sleep/btn_ico_zhankai_nor.png"></image>
      </view>
      <image src="/static/images/sleep/btn_ico_youjiantou_nor.png" @click="tomorrow"></image>
    </view>
