    ...
    <view class="deep_long_view">
      <view class="deep_long_top_view">
        <view class="eeg_alarm_left_view">
          <text class="clock_title_view">平均睡眠潜伏期</text>
        </view>
      ...
      <view class="deep_long_data_view">
        <view class="clock_data_context_view" id="deepYearlatency"></view>
      </view>
...
export default {
  ...
  methods: {
    setECharts() {
      var myChart = echarts.init(document.getElementById('deepYearlatency'))
      ...
      var option = {
        ...
        series: [
          {
            data: [0, 0, 0, 0, 0, 600, 400, 350, 380, 270, 0, 0], // 8小时 == 480分钟
            barWidth: '35%',
            markLine: {
              symbol: 'none',
              data: [
