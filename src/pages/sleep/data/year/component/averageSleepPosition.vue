        ...
        <view class="position_item_view">
          <view v-for="(item2, index2) in item" :key="index2">
            <text v-if="item2.average" class="item_3_view">
              ...
              <text class="tip_view">年日均翻身次数</text>
  ...
  methods: {
    ...
    getSleepImage(val, long) {
      switch (val) {
        case 0:
          if (long) {
            return '/static/images/sleep/icon_yangwo_highlight_long.png'
          } else {
            return '/static/images/sleep/icon_yangwo_highlight.png'
          }
          break

        case 1:
          if (long) {
            return '/static/images/sleep/ico_fuwo_highlight_long.png'
          } else {
            return '/static/images/sleep/ico_fuwo_nor.png'
          }
          break

        case 2:
          if (long) {
            return '/static/images/sleep/ico_youcewo_highligh_long.png'
          } else {
            return '/static/images/sleep/ico_youcewo_nor.png'
          }
          break

        case 3:
          if (long) {
            return '/static/images/sleep/ico_zuocewo_highlight_long.png'
          } else {
            return '/static/images/sleep/ico_zuocewo_nor.png'
          }
          break

        case 4:
          if (long) {
            return '/static/images/sleep/ico_zhan_zuozi_highlight_long.png'
          } else {
            return '/static/images/sleep/ico_zhan_zuozi_nor.png'
          }
          break
      }
    },
