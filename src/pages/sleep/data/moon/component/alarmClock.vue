  ...
  <view class="content_view">
    <view class="alarm_clock_view">
      ...
      <view class="eeg_alarm_clock_view">
        ...
        <view class="eeg_alarm_right_view">
          <view class="tip_top_view">
            <text class="tip_view">本月使用脑电闹钟</text>
            <text>{{ num }}次</text>
          </view>
      ...
      <view class="clock_data_view">
        <view class="clock_data_context_view" id="moonAlarmClock"></view>
      </view>
...
export default {
  ...
  methods: {
    setECharts() {
      var myChart = echarts.init(document.getElementById('moonAlarmClock'))
