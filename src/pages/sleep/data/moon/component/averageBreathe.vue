  ...
  <view class="content_view">
    <view class="alarm_clock_view">
      ...
      <view class="clock_data_view">
        <view class="clock_data_context_view" id="moonAverageBreathe"></view>
      </view>
...
export default {
  ...
  methods: {
    setECharts() {
      var myChart = echarts.init(document.getElementById('moonAverageBreathe'))
