  ...
  <view class="content_view">
    <view class="deep_long_view">
      ...
      <view class="deep_long_data_view">
        <view class="clock_data_context_view" id="deepMoonlatency"></view>
      </view>
...
export default {
  ...
  methods: {
    setECharts() {
      var myChart = echarts.init(document.getElementById('deepMoonlatency'))
      ...
      var option = {
        ...
        series: [
          {
            data: [600, 400, 350, 380, 270, 290, 410], // 8小时 == 480分钟
            barWidth: '40%',
            markLine: {
              symbol: 'none',
              data: [
