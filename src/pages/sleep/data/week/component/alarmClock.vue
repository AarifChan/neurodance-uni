    ...
    <view class="alarm_clock_view">
      ...
      <view class="eeg_alarm_clock_view">
        <view class="eeg_alarm_left_view">
          <text class="clock_title_view">脑电闹钟</text>
        ...
        <view class="eeg_alarm_right_view">
          <view class="tip_top_view">
            <text class="tip_view">本周使用脑电闹钟</text>
            <text>{{ num }}次</text>
          </view>
          <text class="evaluate_view">{{ evaluate }}</text>
        </view>
      </view>

      <view class="clock_data_view">
        <view class="clock_data_context_view" id="alarmWeekClock"></view>
      </view>
...
export default {
  ...
  methods: {
    setECharts() {
      var myChart = echarts.init(document.getElementById('alarmWeekClock'))
