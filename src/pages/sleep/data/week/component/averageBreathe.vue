    ...
    <view class="alarm_clock_view">
      ...
      <view class="eeg_alarm_clock_view">
        <view class="eeg_alarm_left_view">
          <text class="clock_title_view">平均睡眠呼吸研究</text>
        ...
        <view class="eeg_alarm_right_view">
          ...
          <text class="evaluate_view">参考区间：{{ num }}</text>
        </view>
      </view>

      <view class="clock_data_view">
        <view class="clock_data_context_view" id="weekAverageBreathe"></view>
      </view>
...
export default {
  ...
  methods: {
    setECharts() {
      var myChart = echarts.init(document.getElementById('weekAverageBreathe'))
      ...
      var option = {
        ...
        xAxis: {
          type: 'category',
          data: ['2/9', '2/10', '2/11', '2/12', '2/13', '2/14', '2/15'],
          axisLine: {
            show: false, // 隐藏坐标轴轴线
          },
          axisLabel: {
...
.alarm_clock_view {
  ...
  .alarm_bg_view {
    ...
    background: url('~@/static/images/sleep/img_naodiannaozhong.png');
