    ...
    <view class="deep_long_view">
      <view class="deep_long_top_view">
        <view class="eeg_alarm_left_view">
          <text class="clock_title_view">睡眠潜伏期</text>
        ...
        <view class="eeg_alarm_right_view">
          ...
          <!-- <image class="long_image_view" src="/static/images/sleep/ico_shichangzengjia.png"></image> -->
        </view>
      </view>

      <!-- 图表 -->
      <view class="deep_long_data_view">
        <view class="clock_data_context_view" id="deepWeeklatency"></view>
      </view>
...
export default {
  ...
  methods: {
    setECharts() {
      var myChart = echarts.init(document.getElementById('deepWeeklatency'))
