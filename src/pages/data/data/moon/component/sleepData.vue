  ...
  <view>
    <view class="content_view">
      ...
      <view class="sleep_context_view">
        <view class="sleep_view" id="moonMain"></view>
      </view>
    </view>
...
export default {
  ...
  methods: {
    getStateImgae(val) {
      switch (val) {
        case 0:
          return '/static/ico_shujububian.png'

        case 1:
          return '/static/ico_shujushangsheng.png'

        case 2:
          return '/static/ico_shujuxiajiang.png'
      }
    },
    setECharts() {
      var myChart = echarts.init(document.getElementById('moonMain'))
        ...
        series: [
          {
            ...
            data: [120, 8, 101, 134, 290, 230, 220, 120, 8, 101, 134, 290, 230, 220],
            barWidth: '50%',
            itemStyle: {
              color: '#0723C3',
            },
          ...
          },
          {
            ...
            data: [62, 82, 91, 84, 109, 110, 120, 60, 72, 71, 74, 190, 130, 110],
            barWidth: '50%',
            itemStyle: {
              color: '#7967F3',
            },
