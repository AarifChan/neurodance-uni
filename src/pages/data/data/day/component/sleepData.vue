    ...
    <view class="content_view">
      ...
      <view class="eeg_view">
        <view class="button_view" @click="eegView()">
          <text>睡眠脑电波</text>
          <image src="/static/btn_ico_hengpingzhankai_nor.png"></image>
        </view>
      </view>
