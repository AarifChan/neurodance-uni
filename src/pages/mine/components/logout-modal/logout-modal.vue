<template>
  <view class="logout-modal" v-show="show">
    <view class="logout-content" :style="{ opacity: contentOpacity }">
      <view class="content-title">确定退出当前账号</view>
      <view class="btn1" @tap.stop="clickCancel">取消</view>
      <view class="btn2" @tap.stop="clickConfirm">退出</view>
    </view>
  </view>
</template>
